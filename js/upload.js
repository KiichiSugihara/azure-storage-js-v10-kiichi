...
async function execute() {
  ...
  const localTempFilePath = './temp/LICENSE.md';
  ...
  // ローカルファイルで渡すなら、ファイルのパス必要
  await uploadLocalFile(aborter, containerURL, localTempFilePath);
  console.log(`Local file "${localTempFilePath}" is uploaded`);
  // ストリームとは？
